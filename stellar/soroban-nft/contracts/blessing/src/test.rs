...
fn test_initialize_and_mint() {
    ...
    let base_uri = String::from_str(&env, "blessing_base");

    let client = BlessingContractClient::new(&env, &env.register_contract(None, BlessingContract));

    // Initialize the contract
    client.initialize(&admin, &vec![&env, minter.clone()], &base_uri);

    // Mint an NFT
    let token_id =String::from_str(&env, "blessing_1");
...
fn test_unauthorized_mint() {
    ...
    let token_id = String::from_str(&env, "blessing_2");
...
fn test_add_and_remove_minter() {
    ...
    let token_id = String::from_str(&env, "blessing_3");
    ...
    let token_id_2 = String::from_str(&env, "blessing_4");
...
fn test_set_and_get_base_uri() {
    ...
    // Change the base URI
    let new_base_uri = String::from_str(&env, "new_blessing_b");
