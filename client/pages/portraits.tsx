...
const PortraitPage = () => {
        ...
        try {
          ...
          if (uploadedImage && uploadedImage._id) {
            ...
            if (imageUrl) {
              ...
              // Update current image style
              setCurrentImageStyle(selectedStyle);
  ...
  const handleRetry = useCallback(async () => {
    ...
    try {
      ...
      const currentIndex = styles.indexOf(currentImageStyle);
      const nextIndex =
        currentIndex === styles.length - 1 ? 0 : currentIndex + 1;
      const nextStyle = styles[nextIndex];
      setCurrentImageStyle(nextStyle);

      const regeneratedImage: IImage | null =
        await IMAGE_API.regeneratePortrait(uploadedImageId, nextStyle);
  ...
  }, [uploadedImageId, toast, currentImageStyle]);
          ...
          >
            ...
            <LuxuryReveal delay={0.2} className="text-center mb-8 relative">
              ...
              <p className="text-muted-foreground text-sm tracking-wider">
                Free Preview · From $6 to purchase
              </p>
            </LuxuryReveal>
