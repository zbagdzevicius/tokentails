    ...
    return (
        <div className="pt-4 pb-8 px-4 md:px-12 md:pt-4 md:pb-12 text-gray-700 flex flex-col gap-4 animate-appear">
            ...
            <ul className="list-disc pl-5">
                <li><strong>Up (W,SPACE):</strong> Move your character upward.</li>
                <li><strong>Left (A):</strong> Move your character to the left.</li>
                <li><strong>Right (D):</strong> Move your character to the right.</li>
                <li><strong>Dash (Z):</strong> Perform a quick dash in the direction you're moving.</li>
                <li><strong>Knockback (Q):</strong> Use a knockback ability to push and stun enemies away.</li>
            </ul>
