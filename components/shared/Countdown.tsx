...
export const Countdown = ({ targetDate, isDaysDisplayed, isBig, onEnd }: CountdownProps) => {
    ...
    return (
        <div className="flex justify-center items-center h-9 w-full">
            ...
            <div
                className={`w-1 flex flex-col bg-red-500 border-black ${isBig ? "h-12 md:h-14 border-y-4" : "h-7 rem:border-y-[3px]"
                    }`}
            >
            ...
            <div
                className={`flex flex-row border-black bg-red-500 ${isBig ? "h-16 border-y-4" : "h-7 rem:border-y-[3px]"
                    }`}
            >
                <div
                    className={`bg-red-500 font-secondary flex items-center ${isBig ? "h-14 px-2" : "h-6 px-px"
                        }`}
                >
                    <div className="flex flex-row items-center justify-around bg-red-500 text-white w-full h-full">
                        {isDaysDisplayed && (
                            ...
                            >
                                <p className={`${isBig ? "text-3xl" : "text-sm pr-[2px]"}`}>
                                    {timeValues.days}
                                </p>
                        ...
                        {isDaysDisplayed && (
                            <div
                                className={`w-[1px] bg-white ${isBig ? "h-7 mx-1 md:mx-2" : "h-5 rem:mx-[2px]"
                                    }`}
                            ></div>
                        )}
                        <div
                        ...
                        <div
                            className={`w-[1px] bg-white ${isBig ? "h-9 mx-1 md:mx-2" : "h-5 rem:mx-[2px]"
                                }`}
                        ></div>
                        <div
                            className={`${isBig
            ...
            <div
                className={`w-1 flex flex-col bg-red-500 border-black ${isBig ? "h-14 border-y-4" : "h-7 rem:border-y-[4px]"
                    }`}
            >
