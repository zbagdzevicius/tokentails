...
export const Calendar = ({ isRelative }: IProps) => {
    ...
    <div className="relative">
      ...
      >
        ...
        <img
          ...
          alt={`Coin of the day`}
        />
        <h2 className="absolute text-xl z-10 uppercase font-secondary text-black font-bold w-full text-center top-[50%] left-1/2 transform -translate-x-1/2 -translate-y-1/2">
          {currentDay >= 25 ? (
            "Christmas"
          ) : (
            <>
