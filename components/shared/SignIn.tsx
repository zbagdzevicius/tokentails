  ...
  return (
    <form className="flex flex-col items-center gap-4" onSubmit={onSubmit}>
      <input
        type="text"
        placeholder="Email"
        className="outline-none bg-gray-100 hover:bg-gray-200 p2 px-4 rounded-full h-8 w-full max-w-60"
      ...
      <button
        onClick={onSubmit}
        className="group w-full max-w-60 m-auto h-10 px-6 rounded-full bg-yellow-300"
        type="submit"
      >
        ...
        <div className="flex flex-col">
          ...
          <div className="flex md:gap-2 lg:gap-0 flex-col md:flex-row lg:flex-col justify-center">
            ...
            <button
              ...
              className="group w-fit m-auto h-12 px-7 bg-black rounded-full mb-4"
            >
              <div className="relative flex justify-between items-center space-x-4">
          ...
          {!signInWithPasswordEnabled ? (
            <button
              onClick={() => setSignInWithPasswordEnabled(true)}
              className="group w-fit m-auto h-12 px-2 bg-black rounded-full mb-2"
            >
              <div className="relative flex justify-between items-center space-x-4">
                <i className="bx bxl-apple text-h6 text-white"></i>
                <span className="block w-max font-semibold tracking-wide whitespace-nowrap group-hover:text-white text-gray-400 font-pixel">
