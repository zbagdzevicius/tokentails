        ...
        <div className="pt-4 pb-8 px-4 md:px-16 md:pt-4 md:pb-12 text-gray-700 flex flex-col justify-between items-center">
            ...
            <div className="flex flex-col my-4">
                <div className="flex flex-row items-center">
                    <img className="w-7 md:w-8 md:h-8 lg:w-10 lg:h-10 h-7 mr-1" src='/logo/coin.png' />
                    <p className="lg:text-lg text-base font-medium"> Get 20% earnings of your friends
                    </p>
                </div>
                <div className="flex flex-row items-center">
                    <img className="w-7 h-7  md:w-8 md:h-8 lg:w-10 lg:h-10 mr-1" src='/icons/invites/gift.png' />
                    <p className="lg:text-lg text-base font-medium">Get 5k for every gift you send</p>
                </div>
                <div className="flex flex-row items-center">
                    <img className="w-7 h-6  md:w-8 md:h-7 lg:w-10 lg:h-9 mr-1" src='/icons/invites/gift-coin.png' />
                    <p className="lg:text-lg text-base font-medium">Gift contains 50k coins to your friend</p>
                </div>
            </div>
            <PixelButton text="Give a gift" />
        </div>
    );
};
