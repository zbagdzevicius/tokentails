...
export const CatsSlider = () => {
    ...
    const items = [
        <div key={1} className="relative flex items-center justify-center pb-6 aspect-w-16 aspect-h">
        ...
        <div key={2} className="relative flex items-center justify-center pb-6 aspect-w-16 aspect-h">
        ...
        <div key={3} className="relative flex items-center justify-center pb-6 aspect-w-16 aspect-h">
        ...
        <div key={4} className="relative flex items-center justify-center pb-6 aspect-w-16 aspect-h">
        ...
        <div key={5} className="relative flex items-center justify-center pb-6 aspect-w-16 aspect-h">
    ...
    return <Slider items={items} customClass='container' />;
};
