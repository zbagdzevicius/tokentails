...
const sliderItems: { img: string; title: string; explanation: string }[] = [
  {
    ...
    title: "Shelter",
    explanation: "Find and adopt your Purr-Fect companion to start playing",
  },
  {
  ...
  },
  {
    ...
    title: "Purrquest",
    explanation: "Get into an adventure with your cat to find a treasury",
  },
  {
    img: "/game/select/clash-of-claws.jpg",
    title: "Clash Of Claws",
    explanation: "Challenge and compete with your friends",
  },
];
