export const HomePage = () => {
  return (
    <div className="flex items-center flex-col w-full h-full relative z-10">
      ...
      <h2 className="text-balance text-center font-primary uppercase z-0 tracking-tight text-p5 md:text-p2 bg-yellow-300/50 2xl:mt-4 px-4 md:px-8 rounded-full">
        READY TO{" "}
        <span className="text-yellow-300 drop-shadow-[0_2.4px_1.8px_rgba(0,0,0)]">
          PLAY
        </span>{" "}
