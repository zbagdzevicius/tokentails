        ...
        <div className="card__translater">
          <button className="card__rotator relative">
            <div className="card__front">
              <div>
                <div
                  className="bg-cover bg-center w-full h-full rounded-lg filter brightness-50"
                  style={{
                  ...
                  <div>
                    <div className="text-start m-5 max-lg:m-2 max-sm:m-1">
                      ...
                      <div className="flex items-center justify-center">
                        <a href="/purrquest">
                          <button
                            className="[clip-path:polygon(0%_1%,100%_0%,90%_100%,10%_100%)] w-64 max-lg:w-32 max-sm:w-28 h-12 max-lg:h-8 
