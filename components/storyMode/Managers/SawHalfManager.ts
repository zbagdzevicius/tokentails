...
export class SawHalf {
  ...
  update(delta: number) {
    ...
    try {
      ...
      const tileBelowY = Math.floor((this.sprite.y + this.sprite.height * 0.5) / tilemap.tileHeight);
      
      const tileBelowLeftX = Math.floor((this.sprite.x - this.sprite.width * 0.5) / tilemap.tileWidth);
      const tileBelowRightX = Math.floor((this.sprite.x + this.sprite.width * 0.5) / tilemap.tileWidth);
      ...
      const tileBelowLeft = this.groundLayer.getTileAt(tileBelowLeftX, tileBelowY);
      const tileBelowRight = this.groundLayer.getTileAt(tileBelowRightX, tileBelowY);
